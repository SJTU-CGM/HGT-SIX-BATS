...
module load BLAST+/2.10.1
    ...
    python ~/HGT_bats/python_file/merge.py Vert_top_level1_seq_merge.bed > Vert_top_level1_merged_seq.bed
    chomp.pl ~/fish_hgt/data/bmfish.fa
    perl ~/HGT_bats/bat_HLmolMol2/src/getHGTseq.pl ~/fish_hgt/data/bmfish.fa Vert_top_level1_merged_seq.bed  Vert_much_nomasked_level1.fa
    ...
    python ~/HGT_bats/python_file/merge.py Invert_top_level1_seq_merge.bed > Invert_top_level1_merged_seq.bed
    perl ~/HGT_bats/bat_HLmolMol2/src/getHGTseq.pl ~/fish_hgt/data/bmfish.fa Invert_top_level1_merged_seq.bed  Invert_much_nomasked_level1.fa
    ...
    cd trf_repeat_mask
    ~/tools/trf/trf ../Vert_much_nomasked_level1_cluster.fa 2 7 7 80 10 50 500 -m
    ~/tools/trf/trf ../Invert_much_nomasked_level1_cluster.fa 2 7 7 80 10 50 500 -m
    rm *.html
    perl ~/fish_hgt/src/chomp.pl Vert_much_nomasked_level1_cluster.fa.2.7.7.80.10.50.500.mask
    perl ~/fish_hgt/src/chomp.pl Invert_much_nomasked_level1_cluster.fa.2.7.7.80.10.50.500.mask

    python3 ~/persentage_selection/python/remove_masked.py Vert_much_nomasked_level1_cluster.fa.2.7.7.80.10.50.500.mask 0.5 > Vert_much_masked_50per_level1.fa
    python3 ~/persentage_selection/python/remove_masked.py Invert_much_nomasked_level1_cluster.fa.2.7.7.80.10.50.500.mask 0.5 > Invert_much_masked_50per_level1.fa
